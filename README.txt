...
- kopieren von Dateien/Ordner aus copy_this in Shop-Ordner
...
Adjust templates
- basic-theme
 _header.tpl bearbeiten, nach <body>
...
- azure-theme
 layout/base.tpl bearbeiten, nach <body>

    [{oxid_include_dynamic file="../../../modules/marm/basketmerge/out/blocks/merge_basket.tpl" }] 

- Oxid 4.4 braucht jQuery bzw. Template noch anpassen
